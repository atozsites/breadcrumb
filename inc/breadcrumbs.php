...
function atozsites_breadcrumb( $args = array() ) {

	$breadcrumb = apply_filters( 'atozsites_breadcrumb_object', null, $args );

	if ( ! is_object( $breadcrumb ) )
		$breadcrumb = new atozsites_breadcrumb( $args );
...
class atozsites_breadcrumb {
	...
	/**
	 * Sets up the breadcrumb trail properties.  Calls the `atozsites_breadcrumb::add_items()` method
	 ...
	 *     @type array     $labels         Text labels. @see atozsites_breadcrumb::set_labels()
	 *     @type array     $post_taxonomy  Taxonomies to use for post types. @see atozsites_breadcrumb::set_post_taxonomy()
	...
	public function __construct( $args = array() ) {
		...
		$this->args = apply_filters( 'atozsites_breadcrumb_args', wp_parse_args( $args, $defaults ) );
	...
	public function trail() {
		...
		$breadcrumb = apply_filters( 'atozsites_breadcrumb', $breadcrumb, $this->args );
	...
	protected function set_labels() {
		...
		$this->labels = apply_filters( 'atozsites_breadcrumb_labels', wp_parse_args( $this->args['labels'], $defaults ) );
	}
	...
	protected function set_post_taxonomy() {
		...
		$this->post_taxonomy = apply_filters( 'atozsites_breadcrumb_post_taxonomy', wp_parse_args( $this->args['post_taxonomy'], $defaults ) );
	}
	...
	protected function add_items() {
		...
		$this->items = array_unique( apply_filters( 'atozsites_breadcrumb_items', $this->items, $this->args ) );
	}
